                    ...
                    <div className="col">
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <button onClick={() => dispatch('gm')} className="btn btn-success btn-sm">Good Morning</button>
                                <button onClick={() => dispatch('ga')} className="btn btn-warning btn-sm">Good Afternoon</button>
