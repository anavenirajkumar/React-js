    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <NavLink to="/" className="nav-link" style={{fontWeight:'bold'}} >Create Category</NavLink>
        </li>
        <li className="nav-item">
          <NavLink to="/sub" className="nav-link" style={{fontWeight:'bold'}} >Create Sub Category</NavLink>
        </li>
        <li className="nav-item">
          <NavLink to="/product" className="nav-link" style={{fontWeight:'bold'}} >Create Product</NavLink>
        </li>
        <li className="nav-item">
          <NavLink to="/products" className="nav-link" style={{fontWeight:'bold'}}>All Products</NavLink>
        </li>
      </ul>
    </div>
   </div>
