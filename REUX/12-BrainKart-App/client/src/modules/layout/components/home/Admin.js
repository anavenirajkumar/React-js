...
import {deleteProduct, fetchAllProducts} from "../../../../redux/products/products.actions";
                                                    ...
                                                    productInfo.products.map((product) => {
                                                        return (
                                                            <tr key={product._id}>
                                                                ...
                                                                <td>
                                                                    <Link to={`/products/upload/${product._id}`} className="btn btn-secondary btn-sm text-white">Update</Link>
