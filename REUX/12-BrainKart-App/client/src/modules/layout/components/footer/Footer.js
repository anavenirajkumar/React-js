  ...
  <div className="container">
       <div className="row">
              <div className="col-md-4 f-img">
                     ...
                     <img src="https://www.laxmirice.com/wp-content/uploads/2018/10/logo-4.png" alt="footer-image"/>
              </div>
              ...
              <div className="col-md-4">
                  ...
                  <ul className="list-unstyled">
                     <li><a href="/">Home</a></li>
                     <li><a href="https://www.facebook.com/anavenirajkumarprince">About Us</a></li>
                     <li><a href="https://www.facebook.com/anavenirajkumarprince">Contact Us</a></li>   
                 </ul>
              </div>
       </div>
  </div>
    ...
    <div className="row" style={{color: 'white'}}>
     <div className="col-md-5" style={{float: 'left'}}>
         ...
         <div className="col-md-5 f-desig">
             <p>Designed by <a href="https://www.facebook.com/anavenirajkumarprince" target="_blank" style={{color: 'white'}}> Farmer</a></p>
          </div>
      </div>
    </div>
</div>
