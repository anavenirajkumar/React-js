...
import {registerUser} from "../../../redux/users/users.actions";  // Import registerUser
let Register = () => {
    ...
    let handleUsername = (e) => {
       setUser({
        ...
        if(regExp.test(e.target.value)){  // Valid ok
            setUserError({...userError, nameError : ''});
        }
        else {                           // Not Valid ? Enter a proper Name
                        ...
                        <div className="col-md-4 m-auto animated flipInY">
                            {
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body bg-light">
                                         ...
                                         <small>
                                             Have an Account ?
                                             <Link to ='/users/login' className="text-white"> Login </Link>
                                         </small>   
                                    </div>
