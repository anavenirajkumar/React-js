...
mongoose.connect(process.env.MONGODB_LOCAL_DB_URL, {
    useCreateIndex : true,       // console Errors In Server
    useFindAndModify : false,   // console Errors In Server
    useNewUrlParser : true,    // console Errors In Server
    useUnifiedTopology : true // console Errors In Server
}).then((response) => {
